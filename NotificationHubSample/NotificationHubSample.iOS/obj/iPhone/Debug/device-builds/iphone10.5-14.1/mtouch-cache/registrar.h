...
@protocol MSInstallationEnrichmentDelegate;
@class MSInstallationEnrichmentDelegate;
@protocol MSInstallationLifecycleDelegate;
@class MSInstallationLifecycleDelegate;
@protocol MSInstallationManagementDelegate;
@class MSInstallationManagementDelegate;
@class MSInstallationTemplate;
@class MSNotificationHub;
@protocol MSNotificationHubDelegate;
@class MSNotificationHubDelegate;
...
@interface SBTokenProvider : NSObject {
	...
	-(void) setTokenWithRequest:(NSMutableURLRequest *)p0 completion:(void (^)(id))p1;
...
@protocol MSTaggable
	@required @property (nonatomic, assign, readonly) NSSet <NSString *>* tags;
	@required -(BOOL) addTag:(NSString *)p0;
	@required -(BOOL) addTags:(NSArray <NSString *>*)p0;
	@required -(BOOL) removeTag:(NSString *)p0;
	@required -(BOOL) removeTags:(NSArray <NSString *>*)p0;
	@required -(void) clearTags;
@end

@interface MSInstallation : NSObject {
}
	-(BOOL) addTag:(NSString *)p0;
	-(BOOL) addTags:(NSArray <NSString *>*)p0;
	-(void) clearTags;
	-(id) getTemplateForKey:(NSString *)p0;
	-(BOOL) isDirty;
	-(BOOL) removeTag:(NSString *)p0;
	-(BOOL) removeTags:(NSArray <NSString *>*)p0;
	-(BOOL) removeTemplateForKey:(NSString *)p0;
	-(BOOL) setTemplate:(id)p0 forKey:(NSString *)p1;
	-(NSData *) toJsonData;
	-(NSDate *) expirationTime;
	-(void) setExpirationTime:(NSDate *)p0;
	-(NSString *) installationId;
	-(void) setInstallationId:(NSString *)p0;
	-(NSString *) pushChannel;
	-(void) setPushChannel:(NSString *)p0;
	-(NSSet <NSString *>*) tags;
	-(NSDictionary <NSString *, id>*) templates;
	-(NSString *) userId;
...
@protocol MSInstallationEnrichmentDelegate
	@required -(void) notificationHub:(id)p0 willEnrichInstallation:(id)p1;
@end

@interface MSInstallationEnrichmentDelegate : NSObject<MSInstallationEnrichmentDelegate> {
}
	-(id) init;
@end

@protocol MSInstallationLifecycleDelegate
	@required -(void) notificationHub:(id)p0 didSaveInstallation:(id)p1;
	@required -(void) notificationHub:(id)p0 didFailToSaveInstallation:(id)p1 withError:(NSError *)p2;
@end

@interface MSInstallationLifecycleDelegate : NSObject<MSInstallationLifecycleDelegate> {
}
	-(id) init;
@end

@protocol MSInstallationManagementDelegate
	@required -(void) notificationHub:(id)p0 willUpsertInstallation:(id)p1 completionHandler:(void (^)(id))p2;
@end

@interface MSInstallationManagementDelegate : NSObject<MSInstallationManagementDelegate> {
}
	-(id) init;
@end
...
@interface MSInstallationTemplate : NSObject {
	...
	-(BOOL) addTags:(NSArray <NSString *>*)p0;
	-(void) clearTags;
	-(NSString *) getHeaderValueForKey:(NSString *)p0;
	-(BOOL) isDirty;
	-(void) removeHeaderValueForKey:(NSString *)p0;
	-(BOOL) removeTag:(NSString *)p0;
	-(BOOL) removeTags:(NSArray <NSString *>*)p0;
	-(void) setHeaderValue:(NSString *)p0 forKey:(NSString *)p1;
	-(NSString *) body;
	-(void) setBody:(NSString *)p0;
...
@protocol MSNotificationHubDelegate
	@required -(void) notificationHub:(id)p0 didReceivePushNotification:(id)p1;
@end

@interface MSNotificationHubDelegate : NSObject<MSNotificationHubDelegate> {
}
	-(id) init;
@end
...
@interface SBNotificationHub : NSObject {
	...
	-(void) registerNativeWithDeviceToken:(NSData *)p0 tags:(NSSet *)p1 completion:(void (^)(id))p2;
	-(BOOL) registerNativeWithDeviceToken:(NSData *)p0 tags:(NSSet *)p1 error:(NSError **)p2;
	-(void) registerTemplateWithDeviceToken:(NSData *)p0 name:(NSString *)p1 jsonBodyTemplate:(NSString *)p2 expiryTemplate:(NSString *)p3 tags:(NSSet *)p4 completion:(void (^)(id))p5;
	...
	-(void) unregisterAllWithDeviceToken:(NSData *)p0 completion:(void (^)(id))p1;
	-(BOOL) unregisterAllWithDeviceToken:(NSData *)p0 error:(NSError **)p1;
	-(void) unregisterNativeWithCompletion:(void (^)(id))p0;
	-(BOOL) unregisterNativeWithError:(NSError **)p0;
	-(void) unregisterTemplateWithName:(NSString *)p0 completion:(void (^)(id))p1;
